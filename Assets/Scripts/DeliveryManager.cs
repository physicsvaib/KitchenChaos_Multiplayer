...
public class DeliveryManager : NetworkBehaviour
{
  ...
  private void Update()
  {
    ...
    if (spawnRecipeTimer <= 0f)
    {
      ...
      {
        int waitningIndex = UnityEngine.Random.Range(0, recipeListSO.recipeSOList.Count);
        SpawnNewWaitingRecipeClientRpc(waitningIndex);
  ...
  public void DeliverRecipe(PlateKitchenObject plateKitchenObject)
  {
    ...
    DeliverIncorrectRpcServerRpc();
  }

  [ServerRpc(RequireOwnership = false)]
  private void DeliverIncorrectRpcServerRpc()
  {
